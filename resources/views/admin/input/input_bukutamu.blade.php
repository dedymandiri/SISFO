...
<h4 class="card-header info-color white-text text-center py-4">
  <strong>TAMBAH BUKU TAMU</strong>
</h4>
<br>
<form style="width:730px;margin-left:35px;" action="/bukutamu/storebukutamu" method="post">
{{ csrf_field() }}
<br>
  ...
  <div class="form-group">
    ...
    <textarea type="komentar" class="form-control" placeholder="komentar " required="required" name="komentar"  style="height:200px;"></textarea>
  </div>
