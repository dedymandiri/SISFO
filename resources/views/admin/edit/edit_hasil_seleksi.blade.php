...
<h4 class="card-header info-color white-text text-center py-4">
  <strong>Form Edit Hasil Seleksi</strong>
</h4>
<br><br>
@foreach($liat as $li)
<form style="width:730px;margin-left:35px;" action="/hasil_seleksi/update/{{ $li->id_seleksi }}" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
<br>
