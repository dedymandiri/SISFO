...
<h4 class="card-header info-color white-text text-center py-4">
  <strong>Form Edit Kalender Sekolah</strong>
</h4>

<br><br>
@foreach($liat as $li)
<form style="width:730px;margin-left:35px;" action="/kalender_sekolah/update/{{ $li->id_kalender }}" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
<br>
