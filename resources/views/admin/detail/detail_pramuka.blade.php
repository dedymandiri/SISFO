...
<h4 class="card-header info-color white-text text-center py-4">
  <strong>Detail Halaman Pramuka</strong>
</h4>
<br>
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
   ...
   <!-- <tr style="margin-left:10px;" >
       ...
       <div  class="isi">		
			...
			<?php echo $li['deskripsi_pramuka'] ?></div>
		</div>
    @endforeach
  ...
  <div style="margin-top:105px" class="card-header info-color white-text text-center py-4">
      <a href="/pramuka"><button style="margin-left:-750px;" type="submit" class="btn btn-primary" value="Simpan">Kembali</button></a>
  </div>
