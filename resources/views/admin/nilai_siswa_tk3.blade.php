  ...
  <?php $no++ ;?>
    <tr>
        ...
        <td>
            ...
            <a href="/cetak_nilai_siswa_tk3/{{ $rekap->id_rekap }}"><button style="width:30px;height:30px;" target="_BLANK" title="Unduh" type="button" class="btn btn-info"><img style="margin-left:-8px;margin-top:-7px;"  src="{{ asset('admin/docs/assets/img/unduh.png') }}" height="23px" width="20px;"></button></a>
