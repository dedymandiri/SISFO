<!-- CETAK NILAI SISWA UNTUK TINGKAT 2 MULTIMEDIA -->
...
<div style="margin-left:100px;width:900px;height:1500px;" class="card"><br>
  ...
  <div class="text-judul" >
    ...
    <font size="5"><strong>KARTU HASIL UJIAN SISWA TINGKAT 2 <br>
  ...
  <div style="margin-left:55px;margin-top:-40px;">
    <table class="table table-bordered" border="1" cellpadding="7">
      ...
      <tbody align="center">
        <tr>
            <td>{{ 1 }}</td> 
            <td align="left">{{ $mapel[1]->pel_1 }}</td>
            <td>{{ $li->mapel_1 }}</td>
        </tr>
        <tr>
            <td>{{ 2 }}</td> 
            <td align="left">{{ $mapel[1]->pel_2 }}</td>
            <td>{{ $li->mapel_2 }}</td>
        </tr>
        <tr>
            <td>{{ 3 }}</td> 
            <td align="left">{{ $mapel[1]->pel_3 }}</td>
            <td>{{ $li->mapel_3 }}</td>
        </tr>
        <tr>
            <td>{{ 4 }}</td>
            <td align="left">{{ $mapel[1]->pel_4 }}</td>
            <td>{{ $li->mapel_4 }}</td>
        </tr>
        <tr>
            <td>{{ 5 }}</td>
            <td align="left">{{ $mapel[1]->pel_5 }}</td>
            <td>{{ $li->mapel_5 }}</td>
        </tr>
        <tr>
            <td>{{ 6 }}</td>
            <td align="left">{{ $mapel[1]->pel_6 }}</td>
            <td>{{ $li->mapel_6 }}</td>
        </tr>
        <tr>
            <td>{{ 7 }}</td>
            <td align="left">{{ $mapel[1]->pel_7 }}</td>
            <td>{{ $li->mapel_7 }}</td>
        </tr>
        <tr>
            <td>{{ 8 }}</td>
            <td align="left">{{ $mapel[1]->pel_8 }}</td>
            <td>{{ $li->mapel_8 }}</td>
        </tr>
        <tr>
            <td>{{ 9 }}</td>
            <td align="left">{{ $mapel[1]->pel_9 }}</td>
            <td>{{ $li->mapel_9 }}</td>
        </tr>
        <tr>
            <td>{{ 10 }}</td>
            <td align="left">{{ $mapel[1]->pel_10 }}</td>
            <td>{{ $li->mapel_10 }}</td>
        </tr>
