<!-- CETAK NILAI SISWA UNTUK TINGKAT 1 MULTIMEDIA -->
  ...
  <div style="margin-left:55px;margin-top:-40px;">
    <table class="table table-bordered" border="1" cellpadding="7">
      ...
      <tbody align="center">
        <tr>
            <td>{{ 1 }}</td> 
            <td align="left">{{ $mapel[0]->pel_1 }}</td>
            <td>{{ $li->mapel_1 }}</td>
        </tr>
        <tr>
            <td>{{ 2 }}</td> 
            <td align="left">{{ $mapel[0]->pel_2 }}</td>
            <td>{{ $li->mapel_2 }}</td>
        </tr>
        <tr>
            <td>{{ 3 }}</td> 
            <td align="left">{{ $mapel[0]->pel_3 }}</td>
            <td>{{ $li->mapel_3 }}</td>
        </tr>
        <tr>
            <td>{{ 4 }}</td>
            <td align="left">{{ $mapel[0]->pel_4 }}</td>
            <td>{{ $li->mapel_4 }}</td>
        </tr>
        <tr>
            <td>{{ 5 }}</td>
            <td align="left">{{ $mapel[0]->pel_5 }}</td>
            <td>{{ $li->mapel_5 }}</td>
        </tr>
        <tr>
            <td>{{ 6 }}</td>
            <td align="left">{{ $mapel[0]->pel_6 }}</td>
            <td>{{ $li->mapel_6 }}</td>
        </tr>
        <tr>
            <td>{{ 7 }}</td>
            <td align="left">{{ $mapel[0]->pel_7 }}</td>
            <td>{{ $li->mapel_7 }}</td>
        </tr>
        <tr>
            <td>{{ 8 }}</td>
            <td align="left">{{ $mapel[0]->pel_8 }}</td>
            <td>{{ $li->mapel_8 }}</td>
        </tr>
        <tr>
            <td>{{ 9 }}</td>
            <td align="left">{{ $mapel[0]->pel_9 }}</td>
            <td>{{ $li->mapel_9 }}</td>
        </tr>
        <tr>
            <td>{{ 10 }}</td>
            <td align="left">{{ $mapel[0]->pel_10 }}</td>
            <td>{{ $li->mapel_10 }}</td>
        </tr>
        <tr>
            <td>{{ 11 }}</td>
            <td align="left">{{ $mapel[0]->pel_11 }}</td>
            <td>{{ $li->mapel_11 }}</td>
        </tr>
        <tr>
            <td>{{ 12 }}</td>
            <td align="left">{{ $mapel[0]->pel_12 }}</td>
            <td>{{ $li->mapel_12 }}</td>
        </tr>
        <tr>
            <td>{{ 13 }}</td>
            <td align="left">{{ $mapel[0]->pel_13 }}</td>
            <td>{{ $li->mapel_13 }}</td>
        </tr>
      </tbody>
    </table>
